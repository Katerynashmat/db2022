...
ALTER TABLE "Product_storage" ADD FOREIGN KEY ("product_id") REFERENCES "Product" ("id");

ALTER TABLE "Product" ADD FOREIGN KEY ("category_id") REFERENCES "Categories" ("category_id");

ALTER TABLE "Product_storage" ADD FOREIGN KEY ("storage_id") REFERENCES "Storage" ("storage_id");
